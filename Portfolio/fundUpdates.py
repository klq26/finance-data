...
def codeToName(code):
	...
	'159915':'创业板','15993n8':'医药ETF','001180':'医药场外','000968':'养老场外','512880':'证券ETF','512580':'环保ETF',\
...
# 且慢估值的提取范围和顺序范围
def fundEvalScope():
	return ['中证红利','上证50','沪深300','沪深300','中证500','中证500','中证1000','创业板指','创业板指','全指医药','全指医药','养老产业','证券公司','中证环保','中证环保','中证传媒','中证传媒','中证消费']
	pass
