...
function getAStock()
{
	...
	var a2 = new financeKind('沪深300',4.59,aStockColor,null);
	// 中小盘股
	var b1 = new financeKind('中证500',17.12,aStockColor,null);
	// var b2 = new financeKind('中证1000',0.00,aStockColor,null);
	var b3 = new financeKind('创业板',1.77,aStockColor,null);
	// 红利价值
	var c1 = new financeKind('中证红利',5.56,aStockColor,null);
	// 行业股
	var d1 = new financeKind('养老产业',4.69,aStockColor,null);
	var d2 = new financeKind('全指医药',4.11,aStockColor,null);
	var d3 = new financeKind('中证传媒',2.47,aStockColor,null);
	var d4 = new financeKind('中证环保',3.22,aStockColor,null);
	//var d5 = new financeKind('全指消费',0.00,aStockColor,null);
	var d6 = new financeKind('金融地产',1.78,aStockColor,null);
	var d7 = new financeKind('证券公司',2.41,aStockColor,null);
...
{
	// 香港
	var e1 = new financeKind('恒生',0.28,outSideNewColor,null);
	// 海外互联
...
{
	var h1 = new financeKind('原油',1.18,universalGoodsColor,null);
	var h2 = new financeKind('黄金',1.20,universalGoodsColor,null);
...
{
	// 国内债券
	var i1 = new financeKind('可转债',6.05,bondColor,null);
	// 海外债券
...
function getCash()
{
	...
	// 地产定期
	var l1 = new financeKind('地产定期',8.58,cashColor,null);
...
{
	// 公积金
	var m1 = new financeKind('公积金',25.26,frozenCashColor,null);
