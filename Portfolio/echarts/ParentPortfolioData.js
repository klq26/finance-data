...
{
	// 大盘股
	var a1 = new financeKind('上证50',1.50,aStockColor,null);
	var a2 = new financeKind('沪深300',5.44,aStockColor,null);
	// 中小盘股
	var b1 = new financeKind('中证500',15.38,aStockColor,null);
	var b2 = new financeKind('中证1000',1.35,aStockColor,null);
	var b3 = new financeKind('创业板',2.82,aStockColor,null);
	// 红利价值
	var c1 = new financeKind('中证红利',10.23,aStockColor,null);
	// 行业股
	var d1 = new financeKind('养老产业',6.48,aStockColor,null);
	var d2 = new financeKind('全指医药',6.24,aStockColor,null);
	var d3 = new financeKind('中证传媒',3.76,aStockColor,null);
	var d4 = new financeKind('中证环保',3.67,aStockColor,null);
	var d5 = new financeKind('全指消费',0.00,aStockColor,null);
	var d6 = new financeKind('金融地产',1.09,aStockColor,null);
	var d7 = new financeKind('证券公司',0.56,aStockColor,null);
	// 螺丝钉组合定投
	var e1 = new financeKind('大盘股',4.01,nailPortfolioColor,null);
	var e2 = new financeKind('中盘股',3.77,nailPortfolioColor,null);
	var e3 = new financeKind('螺丝钉红利',2.93,nailPortfolioColor,null);
	var e4 = new financeKind('医药养老',0.55,nailPortfolioColor,null);
	var e5 = new financeKind('海外新兴',2.45,nailPortfolioColor,null);
...
{
	// 香港
	var e1 = new financeKind('恒生',0.46,outSideNewColor,null);
	// 海外互联
	var f1 = new financeKind('海外互联网',1.84,outSideNewColor,null);
...
{
	var g1 = new financeKind('德国30',2.40,outSideMatureColor,null);
...
{
	var h1 = new financeKind('原油',1.06,universalGoodsColor,null);
...
{
	// 国内债券
	var i1 = new financeKind('可转债',5.85,bondColor,null);
...
{
	// 货币基金
	var k1 = new financeKind('货币基金',15.11,cashColor,null);
