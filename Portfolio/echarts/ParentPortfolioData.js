...
function getAStock()
{
	...
	var a2 = new financeKind('沪深300',5.60,aStockColor,null);
	// 中小盘股
	var b1 = new financeKind('中证500',16.23,aStockColor,null);
	var b2 = new financeKind('中证1000',1.43,aStockColor,null);
	var b3 = new financeKind('创业板',2.77,aStockColor,null);
	// 红利价值
	var c1 = new financeKind('中证红利',10.99,aStockColor,null);
	// 行业股
	var d1 = new financeKind('养老产业',6.66,aStockColor,null);
	var d2 = new financeKind('全指医药',6.20,aStockColor,null);
	var d3 = new financeKind('中证传媒',3.79,aStockColor,null);
	var d4 = new financeKind('中证环保',3.91,aStockColor,null);
	var d5 = new financeKind('全指消费',2.39,aStockColor,null);
	var d6 = new financeKind('金融地产',1.14,aStockColor,null);
	var d7 = new financeKind('证券公司',0.59,aStockColor,null);
	// 螺丝钉组合定投
	var e1 = new financeKind('大盘股',1.84,nailPortfolioColor,null);
	var e2 = new financeKind('中盘股',2.06,nailPortfolioColor,null);
	var e3 = new financeKind('螺丝钉红利',1.89,nailPortfolioColor,null);
	var e4 = new financeKind('医药100',0.27,nailPortfolioColor,null);
	var e5 = new financeKind('海外新兴',1.48,nailPortfolioColor,null);
...
function getOutsideNew()
{
	...
	// 海外互联
	var f1 = new financeKind('海外互联网',1.99,outSideNewColor,null);
...
{
	var g1 = new financeKind('德国30',2.54,outSideMatureColor,null);
...
{
	var h1 = new financeKind('原油',1.23,universalGoodsColor,null);
...
{
	// 国内债券
	var i1 = new financeKind('可转债',4.97,bondColor,null);
...
{
	// 货币基金
	var k1 = new financeKind('货币基金',16.97,cashColor,null);
