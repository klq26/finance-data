...
{
	// 大盘股
	var a1 = new financeKind('上证50',1.51,aStockColor,null);
	var a2 = new financeKind('沪深300',5.45,aStockColor,null);
	// 中小盘股
	var b1 = new financeKind('中证500',15.23,aStockColor,null);
	var b2 = new financeKind('中证1000',1.34,aStockColor,null);
	var b3 = new financeKind('创业板',2.80,aStockColor,null);
	// 红利价值
	var c1 = new financeKind('中证红利',10.29,aStockColor,null);
	// 行业股
	var d1 = new financeKind('养老产业',6.50,aStockColor,null);
	var d2 = new financeKind('全指医药',6.23,aStockColor,null);
	var d3 = new financeKind('中证传媒',3.65,aStockColor,null);
	var d4 = new financeKind('中证环保',3.68,aStockColor,null);
	var d5 = new financeKind('全指消费',3.27,aStockColor,null);
...
{
	var g1 = new financeKind('德国30',2.33,outSideMatureColor,null);
...
{
	var h1 = new financeKind('原油',1.03,universalGoodsColor,null);
...
{
	// 货币基金
	var k1 = new financeKind('货币基金',15.10,cashColor,null);
